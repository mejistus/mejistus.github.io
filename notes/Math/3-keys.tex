...
\section{例 2：带归一化约束的问题，会导出特征值问题}
...
拉格朗日乘子 \textbackslash{}lambda 不再只是一个辅助常数，而会变成特征值。
