  ...
  return `
    <div class="item" data-text="${data_text}">
      <div class="content">
        ...
        <p class="content-desc">${content_desc}</p>
      </div>
    </div>
  `;
}
...
// append player card as last item
const box = document.querySelector(".timeline");
box.innerHTML += `
  <div class="item" style="align-self:center;">
    <div class="content" style="display:flex;flex-direction:column;align-items:center;">
      <img src="./asserts/2025.jpg" alt="" class="img" loading="lazy">
      <div class="player-card">
        <div class="separator"></div>
        <div class="audio-box">
          <button class="btn-audio prev" onclick="prevSong()" aria-label="上一首">
            <svg viewBox="0 0 24 24"><path d="M6 5h2v14H6zM20 12L10 18V6l10 6z"/></svg>
          </button>
          ...
          <button class="btn-audio next" onclick="nextSong()" aria-label="下一首">
            <svg viewBox="0 0 24 24"><path d="M16 5h2v14h-2zM4 12l10 6V6L4 12z"/></svg>
          </button>
        </div>
