...
function createChild() {
  ...
  const arr = [
    ["ゴメンね素直じゃなくて", "./asserts/1.jpg", "1", "抱歉 口是心非的我"],
    ["梦の中なら云える", "./asserts/2.jpg", "2", "只敢在梦中向你坦白"],
    ["思考回路はショート寸前", "./asserts/3.jpg", "3", "头脑差点就要短路"],
    ["今すぐ会いたいよ", "./asserts/4.jpg", "4", "好想马上见到你~"],
    ["泣きたくなるような moonlight", "./asserts/5.jpg", "5", "在婉若哭泣的月光之下"],
    ["电话も出来ない midnight", "./asserts/6.jpg", "6", "在电话前徘徊到深夜"],
    ["だって纯情 どうしよう", "./asserts/7.jpg", "7", "纯情的我该如何是好"],
    ["ハートは万华镜", "./asserts/8.jpg", "8", "心儿好似万花筒"],
    ["月の光に导かれ", "./asserts/9.jpg", "9", "依循月光的指引"],
    ["何度も 巡り会う", "./asserts/10.jpg", "10", "一次次与你相遇"],
    ["星座の瞬き数え", "./asserts/11.jpg", "11", "细数闪烁的星辰"],
    ["占う恋の行方", "./asserts/12.jpg", "12", "占卜恋爱的结果"],
    ["同じ地球に生まれたの", "./asserts/13.jpg", "13", "我们生在同一国度"],
    ["ミラクル ロマンス", "./asserts/14.jpg", "14", "多么不可思议的罗曼史!"],
    ["几千万の星から", "./asserts/15.jpg", "15", "在满天繁星之中"],
    ["あなたを见つけられる", "./asserts/16.jpg", "16", "有幸与你相遇"],
    ["出会ったときの懐かしい", "./asserts/17.jpg", "17", "深深怀念初次的相逢"],
    ["まなざし忘れない", "./asserts/18.jpg", "18", "难以忘却你的目光"],
    ["も一度 ふたりで weekend", "./asserts/19.jpg", "19", "好想再一次与你共度周末"],
    ["神さま かなえて happy-end", "./asserts/20.jpg", "20", "神啊 请赐予我完美的结局!"],
    ["现在 过去 未来も", "./asserts/21.jpg", "21", "无论过去 现在 或将来"],
    ["あなたに首いったて", "./asserts/22.jpg", "22", "我只为你而痴狂"],
    ["文，生日快乐！", "./asserts/23.jpg", "23", "永永远远~开开心心~"],
  ];
